  ...
  return (
    <div className="min-h-screen bg-white font-roboto antialiased">
      ...
      <section className="relative pt-32 pb-24 px-6 text-center bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center items-center mb-10 select-none">
            ...
            <span className="text-[60px] font-bold" style={{ color: '#e84fcf', letterSpacing: '-2px', fontFamily: 'Inter, Arial, Helvetica, sans-serif' }}>
              obPrize
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <p className="text-slate-600 leading-relaxed">
                AI가 1차 첨삭을 제공하고, 전문 컨설턴트가 최종 검토하여 취업 성공에 한 걸음 더 가까워지세요.
              </p>
            </div>
            <div className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 bg-slate-100 rounded-2xl flex items-center justify-center group-hover:bg-theme/10 transition-colors duration-300">
              ...
              <p className="text-slate-600 leading-relaxed">
                AI가 분석한 맞춤 포지션을 바탕으로 적합한 채용 공고를 추천합니다. 원하는 정보로 쉽고 빠르게 확인하세요.
              </p>
            </div>
            <div className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 bg-slate-100 rounded-2xl flex items-center justify-center group-hover:bg-theme/10 transition-colors duration-300">
              ...
              <p className="text-slate-600 leading-relaxed">
                기업은 AI와 인사 컨설턴트를 통해 적합한 인재를 빠르게 찾고, 효율적으로 관리할 수 있습니다.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-white text-center">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-4xl font-bold mb-12 text-slate-900">
            JobPrize와 함께하는 이유
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
