...
interface ButtonProps {
    color: 'theme' | 'kakao' | 'action' | 'white';
    size: 's' | 'm' | 'l';
    disabled: boolean;
    text: string;
...
const colorClass = {
    ...
    white: 'bg-white text-black border border-gray-300 hover:brightness-95',
};
...
const disabledColorClass = {
    ...
    white: 'bg-white text-black hover:none cursor-not-allowed brightness-50',
};
