...
export const MiddleIntenalBox = ({ children, color }: BoxProps) => {

    return (
        <div className={` ${color == 'semi_theme' ? 'bg-semi_theme' : ''} w-[1024px] min-h-[100px] rounded-lg border border-gray-300 mb-6 ml-[24px] pt-[24px]`}>
            {children}
        </div>
    );
}
