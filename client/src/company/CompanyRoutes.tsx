  ...
  if (isLoading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        <p className="text-gray-600">권한을 확인하는 중입니다...</p>
      </div>
    );
  }
    ...
    <Routes>
      ...
      {!hasSubscription ? (
        ...
        <>
          ...
          <Route path="/job-posting/:jobPostingId/applicants" element={<ApplicationJobPostingPage />} />

          {/* 합격자 관리 */}
          <Route path="/pass" element={<PassPage />} />
          <Route path="/job-posting/:jobPostingId/passes" element={<PassJobPostingPage />} />
