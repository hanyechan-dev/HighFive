...
import type { CareerDescriptionContentCreateDto, CareerDescriptionCreateDto } from "../props/myPageForMemberProps";


type TempContent = CareerDescriptionContentCreateDto & { tempId: number };


interface CareerDescriptionCreateModalProps {
    onCreate: (careerDescriptionCreateDto: CareerDescriptionCreateDto) => void;
...
const CareerDescriptionDetailModal = ({
    onCreate,
    setShowModalType
}: CareerDescriptionCreateModalProps) => {
    ...
    return (
        <>
            <ModalTitle title="경력기술서 작성하기" />
            <Input label={"제목"} placeholder={"경력기술서 제목을 입력해주세요."} size={"l"} disabled={false} type={"text"} value={createDto.title} setValue={setTitle} />
            <ExternalBox>
