...
const LanguageTestCreate = ({ setIsLanguageTestMode }: LanguageTestCreateProps) => {


    const [languageTest, setLanguageTest] = useState<LanguageTestCreateDto>({
        languageType : "",
        testName : "",
        issuingOrg : "",
        grade : "",
    ...
    const setLanguageTestField = (field: keyof LanguageTestCreateDto) => (value: string) => {
...
export default LanguageTestCreate;