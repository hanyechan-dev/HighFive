...
import type { EducationResponseDto, EducationUpdateDto } from "../props/myPageForMemberProps";

interface EducationInfoForMyPage {
    educationResponseDto: EducationResponseDto;
    setEducationUpdateDto: (dto: EducationUpdateDto) => void
}


const EducationInfoForMyPage = ({ educationResponseDto, setEducationUpdateDto }: EducationInfoForMyPage) => {
    ...
    const onClickSaveButton = () => {
        ...
        setEducationUpdateDto(education);
    }
    ...
    return (
        <BigIntenalBox>
            ...
            <div className="flex">
                ...
                <Input label={"학점"} placeholder={""} size={"bibm"} disabled={!isChangeButtonClicked} type={"text"} value={String(gpa)} setValue={setEducationField("gpa")} />
            </div>
            <div className="flex">
