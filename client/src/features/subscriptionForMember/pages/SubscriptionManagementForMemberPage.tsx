...
import type { SubscriptionResponse } from "../../subscription/props/SubscriptionProps";
...
const SubscriptionManagementForMemberPage = () => {
            ...
            <div className="w-[1452px] mx-auto font-roboto text-center py-10">
                ...
                <div className="bg-theme text-white rounded-lg p-8 mb-10 max-w-4xl mx-auto text-left shadow-lg">
                    ...
                    <div className="text-5xl font-bold mb-8">
                        월 9,800원 <span className="text-2xl font-normal">(VAT 포함)</span>
                    </div>
...
export default SubscriptionManagementForMemberPage; 