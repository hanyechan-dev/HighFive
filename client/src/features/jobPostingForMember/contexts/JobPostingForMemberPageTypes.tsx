import type { CareerDescriptionResponseDto, CareerDescriptionSummaryDto, CoverLetterResponseDto, CoverLetterSummaryDto, JobPostingForMemberResponseDto, JobPostingMainCardDto, JobPostingSummaryForMemberDto, JobPostingUnderCardDto, Resume } from "../props/JobPostingForMemberProps";
