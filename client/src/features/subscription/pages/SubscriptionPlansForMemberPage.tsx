...
import PeopleIcon from "../../../company/subscriptionPage/components/PeopleIcon";
import CommonPage from "../../../common/pages/CommonPage";
import PageTitle from "../../../company/common/components/PageTitle";
import DocumentTextIcon from "../../../company/subscriptionPage/components/DocumentTextIcon";
...
const SubscriptionPlansForMemberPage = () => {
    ...
    const onClickPaymentButton = async () =>{
        await createSubscriptionApi(selectedPlan.price, selectedPlan.name, "카카오페이" );
