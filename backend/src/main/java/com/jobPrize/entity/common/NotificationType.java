...
public enum NotificationType {
	...
	public String getMessageByType(User sender, User receiver) {
		return switch(this) {
			case PASS -> sender.getCompany() + this.message;
			case APPROVAL_FEEDBACK, APPROVAL_EDIT, COMPLETE_FEEDBACK, COMPLETE_EDIT -> sender.getConsultant() + " 컨설턴트가 " + receiver.getName() + this.message;
