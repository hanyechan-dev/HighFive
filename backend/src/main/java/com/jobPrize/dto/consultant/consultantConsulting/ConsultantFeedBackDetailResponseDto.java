...
public class ConsultantFeedBackDetailResponseDto {
	...
	public static ConsultantFeedBackDetailResponseDto of(ConsultantConsulting consultantConsulting, List<AiContentResponseDto> aiContents, List<ConsultantContentResponseDto> consultantContents) {
