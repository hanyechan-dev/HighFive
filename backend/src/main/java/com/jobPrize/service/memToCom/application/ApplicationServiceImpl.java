...
public class ApplicationServiceImpl implements ApplicationService {
	...
	public void createApplication(Long id, UserType userType, ApplicationCreateDto applicationCreateDto) {
		...
		Application application = Application.of(member, jobPosting, resumeJson, careerDescriptionJson,
				coverLetterJson);
	...
	public Page<ApplicationSummaryForMemberDto> readApplicationForMemberPage(Long id, Pageable pageable) {
		...
		return new PageImpl<ApplicationSummaryForMemberDto>(applicationSummaryDtos, pageable,
				applications.getTotalElements());
	}

	@Override
	@Transactional(readOnly = true)
	public Page<ApplicationSummaryForCompanyDto> readApplicationForCompanyPage(Long id, Long jobPostingId,
			Pageable pageable) {
		...
		for (Application application : applications) {
			...
			ApplicationSummaryForCompanyDto applicationSummaryForCompanyDto = ApplicationSummaryForCompanyDto
					.of(application, hasCareer, latestEducationLevel, isPassed);

			applicationSummaryForCompanyDtos.add(applicationSummaryForCompanyDto);
		}

		return new PageImpl<ApplicationSummaryForCompanyDto>(applicationSummaryForCompanyDtos, pageable,
				applications.getTotalElements());
	}

	@Override
	@Transactional(readOnly = true)
	public Page<ApplicationSummaryForCompanyDto> readPassedApplicationPage(Long id, Long jobPostingId,
			Pageable pageable) {
		...
		for (Application application : applications) {
			...
			ApplicationSummaryForCompanyDto applicationSummaryForCompanyDto = ApplicationSummaryForCompanyDto
					.of(application, hasCareer, latestEducationLevel, true);
			applicationSummaryForCompanyDtos.add(applicationSummaryForCompanyDto);
	...
	@Override
	@Transactional(readOnly = true)
	public ApplicationResponseForCompanyDto readApplicationForCompany(Long id, UserType userType, Long applicationId) {
		String action = "조회";
		...
		return ApplicationResponseForCompanyDto.from(application);
	}
